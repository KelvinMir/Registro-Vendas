...
function App() {
  ...
  // Função para renderizar a tabela de vendas pagas
  const paidSales = getPaidSales(); // Obtém as vendas pagas
      ...
      <div className='Tables'>
        <div className='TPendentes'>
          ...
          <table>
            ...
            <tbody>
            {sales
              .filter(sale => !sale.installmentValues.every(installment => installment.isPaid)) // Filtra vendas não pagas
              .map((sale, saleIndex) => {
                ...
                return (
                  <React.Fragment key={sale.id || saleIndex}>
                    <tr key={sale.id || saleIndex}>
                      ...
                      <td data-label="Comprador">{sale.buyerName}</td>
                      ...
                      <td>
                        <div className='TdDetalhar'>
                          ...
                          <button className='BotãoExcluir'onClick={() => handleDelete(sale.id)}>Excluir</button>
